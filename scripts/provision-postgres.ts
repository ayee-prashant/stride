...
try {
  ...
  try {
    ...
    await client.query("REVOKE UPDATE, DELETE ON context_revisions, context_events, task_context_briefs, repository_observations, repository_source_events, repository_source_receipts FROM stride_app");
