...
These are superseded starter notes preserved for provenance. Current commands,
authentication, and deployment instructions are in README.md and DEPLOYMENT.md.
Do not apply the identity-header or Worker instructions to the native app.
