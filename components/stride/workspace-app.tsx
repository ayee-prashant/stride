...
import { Archive, ArrowRight, Check, CheckCheck, Circle, CircleDashed, Folder, FolderKanban, LayoutList, ListTodo, Loader2, KeyRound, LogOut, Pencil, Play, Plus, RotateCcw, Search, ShieldCheck, Users } from "lucide-react";
...
type View = "my" | "board" | "projects" | "context" | "agents" | "delivery" | "members";
...
const headings: Record<View, string> = { my: "My Tasks", board: "Project board", projects: "Projects", context: "Project brief", agents: "Team and agents", delivery: "Agent delivery", members: "People" };
